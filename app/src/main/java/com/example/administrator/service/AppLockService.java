...
import com.example.administrator.dao.AppLockDao;
import com.example.administrator.security.EnterPswActivity;
...
public class AppLockService extends Service {
    ...
    private Uri uri = Uri.parse("content://com.example.administrator.applock");
    ...
    public void onCreate() {
        ...
        IntentFilter filter = new IntentFilter("com.example.administrator.applock");
    ...
    class AppLockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.example.administrator.applock".equals(intent.getAction())) {
