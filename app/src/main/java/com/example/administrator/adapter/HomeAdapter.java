...
public class HomeAdapter extends BaseAdapter {
    int[] imageView = {R.drawable.safe,R.drawable.callmsgsafe,R.drawable.app,R.drawable.trojan,
            R.drawable.sysoptimize,R.drawable.taskmanager,R.drawable.netmanager,R.drawable.atools,
            R.drawable.settings};
    String[] names = {"手机防盗","通讯卫士","软件管家","手机杀毒","清理缓存","进程管理",
                    "流量统计","高级工具","设置中心"};
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        iv_icon.setImageResource(imageView[position]);
