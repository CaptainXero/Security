...
import com.example.administrator.dao.TrafficDao;
...
public class TrafficMonitoringActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!flag) {
            startActivity(new Intent(this, FlowStatistics.class));
            finish();
        }
        if (!SystemInfoUtils
    ...
    private void initView() {
        findViewById(R.id.rl_titlebar).setBackgroundColor(Color.parseColor("#cccccc"));
        ImageView mLeftImgv = (ImageView) findViewById(R.id.imgv_leftbtn);
        ((TextView) findViewById(R.id.tv_title)).setText("流量监控");
        mLeftImgv.setOnClickListener(this);
        mLeftImgv.setImageResource(R.drawable.back);
        mCorrectFlowBtn = (Button) findViewById(R.id.bt_correction_flow);
        ...
        mRemindIMGV = (ImageView) findViewById(R.id.iv_traffic_remind);
